...
### הגישה שנבחרה 
בחרתי בגישה מבוססת חוקים, כי המשימה מתמקדת בחשיבה מסודרת ובהתמודדות עם מידע/נתונים לא אחידים של מוצרים בצורה ברורה ומבוקרת.
...
לאחק קיבוץ הרשומות הרלוונטיות, נבחר המחיר הנמוך ביותר מכל קבוצת המוצרים המאוחדת.
